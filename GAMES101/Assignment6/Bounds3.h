...
#ifndef ASSIGNMENT6_BOUNDS3_H
#define ASSIGNMENT6_BOUNDS3_H
#include "Ray.h"
#include "Vector.h"
#include <limits>
#include <array>
                                ...
                                const std::array<int, 3>& dirIsNeg) const
{
    ...
    float t_enter = t_min_x > t_min_y ? t_min_x : t_min_y;
    t_enter = t_enter > t_min_z ? t_enter : t_min_z;
    float t_exit = t_max_x < t_max_y ? t_max_x : t_max_y;
    t_exit = t_exit < t_max_z ? t_exit : t_max_z;
